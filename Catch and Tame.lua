...
local function collectItem(model)
    ...
    if prompt then
        print("🔘 Found Prompt: " .. prompt.Name .. " | ACTION: Interact")
        ...
        warn("❌ No 'E' Prompt found in: " .. model.Name)
    end
end
...
local function startAntiAfk()
    ...
    antiAfkThread = task.spawn(function()
        while antiAfkActive do
            ...
            print("🛡️ Anti-AFK: idle timer reset")
        end
    end)
...
local function resetAll(screenGui)
    ...
    print("✅ All scripts reset and GUI closed.")
end
...
CollectBtn    = makeButton(MainFrame, "✨ Collect",              Color3.fromRGB(70, 180, 100),   45)
HeartCollectBtn = makeButton(MainFrame, "💖 Fruit Collect: OFF", Color3.fromRGB(180, 60, 120),   95)
ServerHopBtn  = makeButton(MainFrame, "🔄 Server Hop",          Color3.fromRGB(80, 120, 200),  145)
AntiAfkBtn    = makeButton(MainFrame, "🛡️ Anti-AFK: OFF",       Color3.fromRGB(120, 80, 180),  195)
ResetBtn      = makeButton(MainFrame, "⛔ Reset All Scripts",   Color3.fromRGB(180, 50, 50),   245)
...
HeartCollectBtn.MouseButton1Click:Connect(function()
    if heartCollectActive then
        stopHeartCollect()
        HeartCollectBtn.Text = "💖 Fruit Collect: OFF"
        HeartCollectBtn.BackgroundColor3 = Color3.fromRGB(180, 60, 120)
    else
        startHeartCollect()
        HeartCollectBtn.Text = "💚 Fruit Collect: ON"
...
print("✅ Merged script loaded!")
print("   - ✨ Collect: Teleport + Hold E")
print("   - 💖 Fruit Collect: Toggle auto-collect for fruits")
print("   - 🔄 Server Hop: Jump to a new server")
print("   - 🛡️ Anti-AFK: Toggle idle kick prevention")
print("   - ⛔ Reset All: Stop all scripts + close GUI")
